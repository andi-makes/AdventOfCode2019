...
namespace day1 {
    std::array<int, 100> masses{
            ...
            138104, 118212, 107207, 79938, 144751, 142226, 116332, 65844, 124779, 104634,
            83143, 94999, 72677, 76926, 83956, 59617, 145999, 62619, 87955, 143030
    };

    int fuel_per_module(int mass_of_module) { return mass_of_module / 3 - 2; }

    int fuel_per_module_part_2(int mass_of_module) {
        int fuel = mass_of_module / 3 - 2;
        if (fuel <= 0) {
            return 0;
        } else {
            return fuel + fuel_per_module_part_2(fuel);
        }
    }
}
